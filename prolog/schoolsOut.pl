...
solve :-
    ...
    (member([ms_gross, _, _, antiquing], Quads) -> member([ms_gross, _, florida, antiquing], Quads); member([ms_gross, _, california, _], Quads)),
    ...
    %The science teacher (who is going water-skiing) is going to travel to either California or Florida.  Mr. McEvoy (who is the history teacher) is going to either Maine or Oregon.
     ...
     (member([_, science, california, water-skiing], Quads) ; member([_, science, florida, water-skiing], Quads)),
     member([mr_mcevoy, history, _, _], Quads),
     (member([mr_mcevoy, history, maine, _], Quads) ; member([mr_mcevoy, history, oregon, _], Quads)),
    ...
    (member([_, english, virginia, _], Quads) -> member([ms_appleton, english, virginia, _], Quads); member([ms_parnell, english, virginia, spelunking], Quads)),


    %The person who is going to Maine (who isn't the gym teacher) isn't the one who is going sightseeing.
