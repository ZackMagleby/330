...
5. 1 point. convertFC general test.
6. 1 point. convert general test.
7. 1 point. duple general test.
8. 1 point. average general test.
9. 1 point. eliminate-larger general test.
10. 1 point. curry2 general test.
"""
    correctoutput = """#t
#f
#t
